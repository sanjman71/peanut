...
namespace :ruby do
  ...
  task :install, :roles => :app do
    ...
    sudo "apt-get install -y ruby1.8-dev ruby1.8 ri1.8 rdoc1.8 irb1.8 libreadline-ruby1.8 libruby1.8 libopenssl-ruby sqlite3 libsqlite3-ruby1.8 libxml-ruby libxml2-dev"
    # These are necessary to install the mechanize gem
    sudo "apt-get install -y libxslt-ruby libxslt-ruby1.8 libxslt1.1 libxslt1-dev libxslt1-dbg"
